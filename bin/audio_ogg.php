...
$audioBasePath = '/var/www/VHOSTS/alquran.cloud/cdn/quran/audio/ogg/';
...
foreach ($editions as $edition) {
    ...
    foreach ($medias as $media) {
        echo $media->type . "\n";
        if ($media->type == 'ogg' && $edition->getIdentifier() == 'ar.saoodshuraym' || $edition->getIdentifier() == 'ar.minshawimujawwad') {
