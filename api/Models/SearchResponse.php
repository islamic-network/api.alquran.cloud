...
class SearchResponse extends QuranResponse
{
     ...
     * @param string $lang
     */
    public function __construct(EntityManager $em, $keyword, $surat = 'all', $lang = '')
    {
    ...
    public function load()
    {
        ...
        if ((int) $this->surat > 0 && (int) $this->surat < 115) {
            if ($this->lang != '') {
                $result = $this->entityManager->getRepository("\Api\Entities\Doctrine\Primary\Ayat")->createQueryBuilder('a')
